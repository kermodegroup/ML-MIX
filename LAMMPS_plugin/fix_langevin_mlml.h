...
#ifndef LMP_FIX_LANGEVIN_MLML_H
#define LMP_FIX_LANGEVIN_MLML_H

#include "fix.h"

namespace LAMMPS_NS {

class FixLangevinMLML : public Fix {
 public:
  FixLangevinMLML(class LAMMPS *, int, char **);
  ~FixLangevinMLML() override;
