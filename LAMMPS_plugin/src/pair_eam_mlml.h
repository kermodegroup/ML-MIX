...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(eam/mlml,PairEAMMLML);
// clang-format on
#else

#ifndef LMP_PAIR_EAM_MLML_H
#define LMP_PAIR_EAM_MLML_H

#include "pair.h"

namespace LAMMPS_NS {

class PairEAMMLML : public Pair {
 public:
  ...
  PairEAMMLML(class LAMMPS *);
  ~PairEAMMLML() override;
